...
const { getExportedDefinitions, isConstAssertion, isNamedFile, unwrapExpression } = require('./utils.js');
...
module.exports = {
  meta: {
    ...
    messages: {
      ...
      nonConstantInConstantsFile: "Non-constant declaration '{{ name }}' should not be in constants.ts. Move it to the appropriate file.",
    },
    schema: [],
  },
  create(context) {
